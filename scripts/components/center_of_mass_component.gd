...
var current_com_offset_3d: Vector3 = Vector3.ZERO
...
func recalculate_com() -> void:
	...
	for container: HexInventoryComponent in container_inventories:
		...
		# Map 2D container space to 3D sled space (X = lateral, Z = fore/aft, Y = fixed height 0.35m)
		var container_com_3d: Vector3 = Vector3(com_2d.x, 0.35, -com_2d.y)
	...
	GlobalEvents.emit_inventory_updated(&"sled_composite", current_total_mass_kg, Vector2(current_com_offset_3d.x, current_com_offset_3d.z))
