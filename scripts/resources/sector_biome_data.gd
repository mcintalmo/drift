...
@export var elevation_amplitude: float = 2.4
...
@export var cliff_fault_density: float = 0.18 # Frequency of dramatic plateau cliffs and chasms
...
@export_range(0.0, 1.0, 0.05) var boulder_density: float = 0.12
@export_range(0.0, 1.0, 0.05) var pine_tree_density: float = 0.18
@export_range(0.0, 1.0, 0.05) var industrial_debris_density: float = 0.06
@export_range(0.0, 0.5, 0.02) var crevasse_chasm_chance: float = 0.04

@export_group("POI Spawn Probabilities (Per Hex Tile)")
@export_range(0.0, 0.3, 0.01) var overturned_sled_wreck_chance: float = 0.04
@export_range(0.0, 0.3, 0.01) var abandoned_corpo_facility_chance: float = 0.02
@export_range(0.0, 0.1, 0.005) var hot_spring_basin_chance: float = 0.02 # Reduced to 2% for rare oasis discovery
@export_range(0.0, 1.0, 0.05) var hot_spring_cluster_boost: float = 0.35 # Modest contiguous expansion
@export_range(0.0, 0.4, 0.02) var ground_crate_cache_chance: float = 0.10
